...
class _SecondState extends State<Second> {
  ...
  _loadData() async {
    ...
    setState(() {
      List<String>? savedItems = prefs.getStringList('work_numbers'); // مفتاح خاص بالصفحة الثانية
      if (savedItems != null) {
  ...
  _saveData() async {
    ...
    prefs.setStringList('work_numbers', savedItems); // حفظ البيانات باستخدام مفتاح خاص بالصفحة الثانية
  }
